locals {
  ...
  blacksabbath_bot_secrets = {
    "BLACKSABBATH_APP_ID"          = module.onepassword_item_github_blacksabbath_bot.fields.github_app_id
    "BLACKSABBATH_APP_PRIVATE_KEY" = module.onepassword_item_github_blacksabbath_bot.fields.github_app_private_key
  }
}
